...
public class YogaSongs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize category
        nowPlayingCategory = getString(R.string.song_category_2);
        ...
        if (intentInfo == null) {
            ...
            //todo remove log
            Log.v("Yoga", "intentInfo is null, calling retrieveSharedPreferences");
        ...
        songs.add(new Songs(getString(R.string.song_name_10), getString(R.string.artist_name_10), R.drawable.yoga_1, getString(R.string.song_category_2)));
        songs.add(new Songs(getString(R.string.song_name_11), getString(R.string.artist_name_11), R.drawable.mind_soul, getString(R.string.song_category_2)));
        songs.add(new Songs(getString(R.string.song_name_12), getString(R.string.artist_name_12), R.drawable.reach_balance, getString(R.string.song_category_2)));
        songs.add(new Songs(getString(R.string.song_name_13), getString(R.string.artist_name_13), R.drawable.chakra, getString(R.string.song_category_2)));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent nowPlayingDetailsScreen = new Intent(YogaSongs.this, NowPlaying.class);
    ...
    public void updateViews() {
        ...
        //Find TextView with drawableTop which shows Yoga Section Icon
        TextView yogaButton = findViewById(R.id.yoga_button);
        ...
        //On icon row, change background color of yoga button to indicate that it's the active activity
        yogaButton.setBackgroundColor(getResources().getColor(R.color.orangeDark));

        //Change Color of category description background
        categoryDescription.setBackgroundColor(getResources().getColor(R.color.orangeDark));

        //Set category description text
        categoryDescription.setText(getString(R.string.song_category_2_descrip));

        //Change Color of Now Playing Area
        linearLayout.setBackgroundColor(getResources().getColor(R.color.orangeDark));

        //Change background color of app title TextView
        songsListLayout.setBackgroundColor(getResources().getColor(R.color.orange));
    }
    ...
    public void retrieveSharedPreferences() {
        ...
        //todo remove log
        Log.v("Yoga", "SharedPreferences Song Name: " + nowPlayingSongName);
        ...
        //todo remove log
        Log.v("Yoga", "Retrieved SharedPreferences");
    }
    ...
    public void updateSharedPreferences() {
        ...
        //todo remove log
        Log.v("YogaSongs", "The category is now " + nowPlayingCategory + "\nYogaSongs is passing the variables");
    }
    ...
    public void attachListeners() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent homeIntent = new Intent(YogaSongs.this, MainActivity.class);
        ...
        meditationButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent meditationIntent = new Intent(YogaSongs.this, MeditationSongs.class);
        ...
        energyButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent energyIntent = new Intent(YogaSongs.this, EnergySongs.class);
        ...
        sleepButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent sleepIntent = new Intent(YogaSongs.this, SleepSongs.class);
        ...
        nowPlayingSongNameTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent songDetail = new Intent(YogaSongs.this, NowPlaying.class);
                updateSharedPreferences();
    ...
    public void toggleMusic() {
        ...
        if (isPlaying) {
            ...
            //todo remove logs
            Log.v("Yoga", "Music was PAUSED by user. SharedPreferences updated");
            ...
            //todo remove logs
            Log.v("Yoga", "User pressed PLAY. SharedPreferences updated");
        }
