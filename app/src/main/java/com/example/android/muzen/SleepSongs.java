...
public class SleepSongs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Initialize category
        nowPlayingCategory = getString(R.string.song_category_4);
        ...
        if (intentInfo == null) {
            ...
            //todo remove log
            Log.v("Sleep", "intentInfo is null, calling retrieveSharedPreferences");
            ...
            categoryArrayCurrentPosition = intent.getIntExtra("CategoryArrayNowPlayingSongPosition", 4);
        ...
        songs.add(new Songs(getString(R.string.song_name_6), getString(R.string.artist_name_6), R.drawable.healing_sleep, getString(R.string.song_category_4)));
        songs.add(new Songs(getString(R.string.song_name_7), getString(R.string.artist_name_7), R.drawable.peaceful_slumber, getString(R.string.song_category_4)));
        songs.add(new Songs(getString(R.string.song_name_8), getString(R.string.artist_name_8), R.drawable.above_the_sky, getString(R.string.song_category_4)));
        songs.add(new Songs(getString(R.string.song_name_9), getString(R.string.artist_name_9), R.drawable.sleeping_abstract, getString(R.string.song_category_4)));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent nowPlayingDetailsScreen = new Intent(SleepSongs.this, NowPlaying.class);
    ...
    public void updateViews() {
        ...
        //Find TextView with drawableTop which shows Sleep Section Icon
        TextView sleepButton = findViewById(R.id.sleep_button);
        ...
        //On icon row, change background color of sleep button to indicate that it's the active activity
        sleepButton.setBackgroundColor(getResources().getColor(R.color.blueDark));

        //Change Color of category description background
        categoryDescription.setBackgroundColor(getResources().getColor(R.color.blueDark));

        //Set category description text
        categoryDescription.setText(getString(R.string.song_category_4_descrip));

        //Change Color of Now Playing Area
        linearLayout.setBackgroundColor(getResources().getColor(R.color.blueDark));

        //Change background color of app title TextView
        songsListLayout.setBackgroundColor(getResources().getColor(R.color.blue));
    }
    ...
    public void retrieveSharedPreferences() {
        ...
        //todo remove log
        Log.v("Sleep", "SharedPreferences Song Name: " + nowPlayingSongName);
        ...
        categoryArrayCurrentPosition = sharedPreferences.getInt("CategoryArrayNowPlayingSongPosition", 4);

        //todo remove log
        Log.v("Sleep", "Retrieved SharedPreferences");
    }
    ...
    public void updateSharedPreferences() {
        ...
        //todo remove log
        Log.v("SleepSongs", "The category is now " + nowPlayingCategory + "\nSleepSongs is passing the variables");
    }
    ...
    public void attachListeners() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent homeIntent = new Intent(SleepSongs.this, MainActivity.class);
        ...
        meditationButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent meditationIntent = new Intent(SleepSongs.this, MeditationSongs.class);
        ...
        energyButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent energyIntent = new Intent(SleepSongs.this, EnergySongs.class);
        ...
        yogaButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent yogaIntent = new Intent(SleepSongs.this, YogaSongs.class);
        ...
        nowPlayingSongNameTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent songDetail = new Intent(SleepSongs.this, NowPlaying.class);
                updateSharedPreferences();
    ...
    public void toggleMusic() {
        ...
        if (isPlaying) {
            ...
            //todo remove logs
            Log.v("Sleep", "Music was PAUSED by user. SharedPreferences updated");
            ...
            //todo remove logs
            Log.v("Sleep", "User pressed PLAY. SharedPreferences updated");
        }
